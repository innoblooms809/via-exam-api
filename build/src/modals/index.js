...
// ═══════════════════════════════════════════════════════════════
// QUESTION PAPER ↔ EXAM + TEACHER
// ═══════════════════════════════════════════════════════════════
QuestionPaper_modal_1.default.belongsTo(User_modal_1.default, {
    foreignKey: "teacherId",
    targetKey: "userId",
    as: "teacher",
});
QuestionPaper_modal_1.default.belongsTo(Exam_modal_1.default, {
    foreignKey: "examId",
    targetKey: "examId",
    as: "exam",
});
Exam_modal_1.default.hasMany(QuestionPaper_modal_1.default, {
    foreignKey: "examId",
    sourceKey: "examId",
    as: "questionPapers",
});
