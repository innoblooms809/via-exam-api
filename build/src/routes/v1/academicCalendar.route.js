...
router.get("/exam-schedule", academicCalendar_controller_1.default.getExamSchedule);
router.post("/exam-schedule", academicCalendar_controller_1.default.createExamSchedule);
router.post("/bulk-delete", academicCalendar_controller_1.default.deleteEvents);
